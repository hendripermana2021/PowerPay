            ...
            <div class="grid sm:grid-cols-2">
                <div class="flex items-center order-2 sm:order-1">
                    <div>
                        ...
                        >
                        Kami hadir untuk mengelola transaksi pembayaran
                        anda dengan mudah. Menyediakan platform yang dapat diakses
                        oleh semua kalangan masyarakat, Kami adalah penyedia solusi
                        pembayaran listrik yang inovatif dan terpercaya.
                        </p>
                    </div>
                </div>
